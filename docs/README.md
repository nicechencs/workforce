...
- [P0 页面线框规范](product-ui/03-p0-wireframes.md)（侧栏与 IA §2 对齐；§7 为 M3 只读目录过渡；§10/§11 为 M7 画布与自定义 Team）
...
- [决策登记（项目制主对象；M0–M3 已冻结；M7 补齐 Team/Workflow 编排）](planning/decision-register.md)
